 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class any_write_action_in_course_chat extends \core\analytics\indicator\any_write_action_in_course {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:anywriteincoursechat', 'motbot');
    }
    ...
    protected function calculate_sample($sampleid, $sampleorigin, $starttime = false, $endtime = false) {
        ...
        $select = "courseid = :courseid AND anonymous = :anonymous AND (crud = 'c' OR crud = 'u') AND component = :component";
        $params = array('courseid' => $course->id, 'anonymous' => '0', 'component' => 'mod_chat');
