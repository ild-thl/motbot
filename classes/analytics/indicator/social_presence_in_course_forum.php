...
/**
 * Socail presence in forum indicator.
 *
 * @package   mod_motbot
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class social_presence_in_course_forum extends \mod_motbot\analytics\indicator\social_presence_in_course_activity {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:socialpresenceincourseforum', 'motbot');
    }
